...
EB_ENVVARS_USER_MODULES_OPTION = eb_option(
...
EB_EXTERNAL_MODULES_METADATA_OPTION = eb_option(
...
EB_MODULECLASSES_OPTION = eb_option(
    '--moduleclasses',
    type=ctyp.DelimitedString(delimiter=','),
    help=(
...
EB_PACKAGE_NAMING_SCHEME_OPTION = eb_option(
...
EB_RECURSIVE_MODULE_UNLOAD_OPTION = eb_option(
...
EB_REPOSITORY_OPTION = eb_option(
    '--repository',
...
EB_SEARCH_PATH_CPP_HEADERS_OPTION = eb_option(
...
EB_SEARCH_PATH_LINKER_OPTION = eb_option(
    '--search-path-linker',
...
EB_SOURCEPATH_DATA_OPTION = eb_option(
    '--sourcepath-data',
    type=click.Path(file_okay=False, dir_okay=True, resolve_path=True),
...
EB_SUBDIR_DATA_OPTION = eb_option(
    '--subdir-data',
    type=str,
...
EB_SUBDIR_MODULES_OPTION = eb_option(
    '--subdir-modules',
    type=str,
...
EB_SUBDIR_SOFTWARE_OPTION = eb_option(
    '--subdir-software',
    type=str,
...
EB_SUBDIR_USER_MODULES_OPTION = eb_option(
    '--subdir-user-modules',
    type=str,
    help='Base path of user-specific modules relative to --envvars-user-modules',
)

EB_SUFFIX_MODULES_PATH_OPTION = eb_option(
    '--suffix-modules-path',
    type=str,
...
EB_TESTOUTPUT_OPTION = eb_option(
    '--testoutput',
...
EB_TMP_LOGDIR_OPTION = eb_option(
    '--tmp-logdir',
    type=click.Path(file_okay=False, dir_okay=True, resolve_path=True),
    help='Log directory where temporary log files are stored',
)

EB_TMPDIR_OPTION = eb_option(
    '--tmpdir',
    type=click.Path(file_okay=False, dir_okay=True, resolve_path=True),
...
def EB_CONFIGURATION_OPTIONS(func):
    """Decorator to apply all EasyBuild configuration options to a command."""
    for opt in _OPTIONS:
        func = opt(func)
